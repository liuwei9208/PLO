<x-admin-layout>
  <div class="p-4 mx-auto max-w-full md:p-6">
    ...
    <!-- Search & Limit -->
    <form
      action="{{ route('admin.review.index') }}"
      method="get"
      id="search_form"
              ...
              <tr>
                ...
                <td class="px-5 py-4 sm:px-6">
                  <div class="flex items-center">
                    <div class="flex flex-col items-end">
                      ...
                      >
                        {{ $review->created_at ? \Carbon\Carbon::createFromTimeString($review->created_at)->format('Y/m/d') : '' }}
                      </span>
                      <span
                        class="block text-gray-500 white-space-nowrap text-theme-sm dark:text-gray-400"
                      >
                        {{ $review->created_at ? \Carbon\Carbon::createFromTimeString($review->created_at)->format('H:i') : '' }}
                      </span>
                    </div>
                  </div>
                </td>
                ...
                <td class="px-5 py-4 sm:px-6">
                  <div class="flex items-center justify-end">
                    <a
                      href="{{ url('/admin/review/' . $review->id) }}"
