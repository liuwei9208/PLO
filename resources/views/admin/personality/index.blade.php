  ...
  <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
    ...
    <div x-data="{ pageName: `性格マスター`}">
      <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        ></h2>
        <a
          href="{{ url('/admin/personality/add') }}"
    ...
    <!-- Search & Limit -->
    <form
      action="{{ route('admin.personality.index') }}"
      method="get"
      id="search_form"
              ...
              <tr>
                ...
                <td class="px-5 py-4 sm:px-6">
                  <div class="flex items-center justify-end">
                    <a
                      href="{{ url('/admin/personality/' . $personality->id) }}"
    ...
    <div class="mb-10 flex justify-center">
      <div class="flex align-center rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        @for ($i = 1; $i <= $pages; $i++)
          ...
          @else
            <a
              href="{{ route('admin.personality.index', array_merge(request()->all(), ['page' => $i])) }}"
              class="flex items-center justify-center w-10 h-10 border-r border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
              {{ $i }}
            </a>
