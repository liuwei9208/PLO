        ...
        <div class="home-content">
            <div class="home-header">
                ...
                <div class="mobile-header-logo">
                    <img src="{{ asset('assets/img/shops/shizuku/footer-logo.png') }}" alt="Shizuku Logo">
                </div>
                ...
                <div class="menu-button" id="mobileMenuButton">
                ...
                <div class="page-top-section">
                    ...
                    <a href="#" class="page-top-text" onclick="window.scrollTo({top: 0, behavior: 'smooth'}); return false;" class="page-top-social">
