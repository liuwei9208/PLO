<x-shizuku-page-layout page-title="ACCESS" page-subtitle="アクセス情報" breadcrumb="すすきのhigh grade health 雫 ＞ トップページ ＞ アクセス情報"
    :assets="['resources/scss/shops/shizuku/access.scss']" :banners="$banners">
    <section class="access-section">
        ...
        <div class="access-content">
            ...
            <div class="access-content-item">
                <h2> 営業時間 </h2>
                <p> {{ $shop_item->open_start->format('H:i') . '〜' . $shop_item->open_end->format('H:i') }} </p>
            </div>
            <div class="access-content-item">
                <h2> 店舗情報 </h2>
                <p> {{ $shop_item->memo }} </p>
