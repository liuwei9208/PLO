        ...
        <div class="home-content">
            ...
            <div class="home-news">
                <x-public.shops.news-section title="news" slider-id="newsSlider"
                    default-image="assets/img/shops/pussycat/news-image.png" variant="news" />
                <x-public.shops.news-section title="photo diary" slider-id="diarySlider"
                    default-image="assets/img/shops/pussycat/diary-image.png" variant="diary" />
            </div>
            <x-public.shops.pickup-section header-background-image="assets/img/shops/pussycat/pickup-bg.png"
                title-en="PICK UP" title-ja="ピックアップ" description="当店の女の子イチオシ情報です" badge-text="当店一押し" :cast-images="[
                    ['image' => 'assets/img/shops/pussycat/pickup-cast-1.png', 'alt' => 'Cast 1'],
                    ['image' => 'assets/img/shops/pussycat/pickup-cast-2.png', 'alt' => 'Cast 2'],
                ]"
                frame-image="assets/img/shops/pussycat/card-frame-
                    ...
                    <div class="ranking-badge ranking-no1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="240" height="154" viewBox="0 0 240 154"
                            ...
                            <path
                                ...
                                fill="white" />
                            <defs>
                                <linearGradient id="paint0_linear_no1" x1="12.5" y1="154" x2="240"
                                    y2="-1.12639e-05" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="ranking-badge ranking-no2">
                        <svg width="220" height="137" viewBox="0 0 220 137" fill="none"
                            ...
                            <path
                                ...
                                fill="white" />
                            <defs>
                                <linearGradient id="paint0_linear_8_59" x1="11.4583" y1="137" x2="216.03"
                                    y2="-5.69119" gradientUnits="userSpaceOnUse">
