<x-pussycat-page-layout page-title="NEW CAST" page-subtitle="新人情報" breadcrumb="すすきのhigh grade health 雫 ＞ トップページ ＞ 新人情報"
    :assets="['resources/scss/shops/pussycat/newcast.scss']" :banners="$banners">
    <section class="newcast-section">
        ...
        @foreach ($new_girls as $new_girl)
            <x-public.shops.new-girl-card
                ...
                :gradient=false datetextColor="#EAF205" overlay-opacity="0.7" name-color="#FFFFFF"
                measurements-color="#FFFFFF" :cardGradient=false carddividerColor="#ffffff"
