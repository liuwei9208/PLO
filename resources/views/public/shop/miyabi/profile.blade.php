    ...
    <div class="flex w-full mt-6 mobile-profile-content max-md:mt-0">
        <div class="profile-left-colum">
            <div class="girl-info-section-wrapper">
                ...
                <div class="girl-info-section">
                    ...
                    <img src="{{ asset('assets/img/shops/miyabi/card-frame.png') }}" alt="Frame" class="cast-frame">
                </div>
        ...
        <div class="profile-right-column">
            <div class="girl-basic-info">
                ...
                {{-- <p class="girl-basic-info-caption">☆☆Ｇカップ巨乳×癒しのオーラ全開☆☆</p> --}}
            </div>
            @if (count($qas) > 0)
                        ...
                        @foreach ($options as $option)
                            <div class="girl-play-item">
                                <div class="girl-play-item-title">
                                    <h4>{{ number_format($option->option_price) . '円' }}</h4>
                                </div>
                                <div class="girl-play-item-content">
                                    @php
                                        $option_names = explode(',', $option->option_names);
                                    @endphp
                                    @foreach ($option_names as $option_name)
                                        <div class="girl-play-item-details">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                viewBox="0 0 15 15" fill="none">
                                                <circle cx="7.5" cy="7.5" r="7.5" fill="#D90D32" />
                                            </svg>
                                            <p>{{ $option_name }}</p>
                                        </div>
                                    @endforeach
                ...
                <div class="girl-schedule-header">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="23" viewBox="0 0 21 23"
                        ...
                        <path
                            ...
                            fill="#FEFEFE" />
                        <path d="M16.6569 9.97266H4.36177V11.5898H16.6569V9.97266Z" fill="#FEFEFE" />
                        <path d="M16.6569 13.5664H4.36177V15.0938H16.6569V13.5664Z" fill="#FEFEFE" />
                        <path d="M13.2215 17.1602H4.36177V18.6875H13.2215V17.1602Z" fill="#FEFEFE" />
                    </svg>
                    <h3>週間出勤予定</h3>
                </div>
            ...
            <div class="girl-manager-comment-section">
                <div class="girl-manager-comment-header">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18" viewBox="0 0 21 18"
                        fill="none">
                        <path
                            d="M17.7083 6.25C18.5371 6.25 19.332 6.57924 19.918 7.16529C20.5041 7.75134 20.8333 8.5462 20.8333 9.375V12.5C20.8333 13.3288 20.5041 14.1237 19.918 14.7097C19.332 15.2958 18.5371 15.625 17.7083 15.625V16.6313C17.7083 17.7354 16.4208 18.3385 15.5729 17.6313L13.1646 15.625H10.4167C9.58787 15.625 8.79301 15.2958 8.20696 14.7097C7.62091 14.1237 7.29167 13.3288 7.29167 12.5V9.375C7.29167 8.5462 7.62091 7.75134 8.20696 7.16529C8.79301 6.57924 9.58787 6.25 10.4167 6.25H17.7083ZM14.5833 0C15.4121 0 16.207 0.32924 16.793 0.915291C17.3791 1.50134 17.7083 2.2962 17.7083 3.125V4.16667H9.375C8.26993 4.16667 7.21012 4.60565 6.42872 5.38706C5.64732 6.16846 5.20833 7.22827 5.20833 8.33333V12.5C5.20833 13.5875 5.625 14.5792 6.30833 15.3208L5.20833 16.1458C4.35 16.7896 3.125 16.1771 3.125 15.1042V13.5417C2.2962 13.5417 1.50134 13.2124 0.915291 12.6264C0.32924 12.0403 0 11.2455 0 10.4167V3.125C0 2.2962 0.32924 1.50134 0.915291 0.915291C1.50134 0.32924 2.2962 0 3.125 0H14.5833Z"
                            fill="#FEFEFE" />
                    </svg>
                    <h3>店長コメント</h3>
                </div>
                                        ...
                                        <div class="girl-review-stars">
                                            @for ($j = 0; $j < $review->review_average_point; $j++)
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19"
                                                    ...
                                                    <path
                                                        d="M12.3398 6.81934L12.457 7.09668L12.7568 7.12305L18.7803 7.64551L14.2227 11.5977L13.9951 11.7939L14.0625 12.0879L15.4209 17.9609L10.2578 14.8467L10 14.6914L9.74219 14.8467L4.57812 17.9609L5.9375 12.0879L6.00488 11.7939L5.77734 11.5977L1.21875 7.64551L7.24316 7.12305L7.54297 7.09668L7.66016 6.81934L10 1.28418L12.3398 6.81934Z"
                                                        fill="#A45C72" stroke="#A45C72" />
                                                </svg>
                                            @endfor
