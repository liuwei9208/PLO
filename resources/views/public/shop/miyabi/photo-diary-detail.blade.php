...
<x-miyabi-page-layout page-title="PHOTO DIARY DETAIL" page-subtitle="{{ $diary->cast_name }}"
        ...
        <div class="photo-diary-details-section-content">
            ...
            <div class="photo-diary-details-section-content-right">
                ...
                <div class="blog-pagination">
                    @if ($prevDiary)
                        <a href="{{ route('public.shops.shop.photo-diary.detail', ['shop' => 'miyabi', 'id' => $prevDiary->id]) }}"
                    ...
                    @endif
                    <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'miyabi']) }}"
                        class="blog-pagination-btn blog-pagination-list">
                        <p>一覧へ</p>
                    </a>
                    @if ($nextDiary)
                        <a href="{{ route('public.shops.shop.photo-diary.detail', ['shop' => 'miyabi', 'id' => $nextDiary->id]) }}"
