<x-miyabi-page-layout page-title="SCHEDULE" page-subtitle="出勤情報" breadcrumb="すすきの Luxury Room 雅 ＞ トップページ ＞ 出勤情報"
    ...
    <div class="schedule-menu">
        <div class="search-list">
            ...
            <img src="{{ asset('assets/img/shops/miyabi/schedule-icon.png') }}" alt="出勤日で検索" class="schedule-icon">
            <p>出勤日で検索</p>
        </div>
        <form action="{{ route('public.shops.shop.schedule', ['shop' => 'miyabi']) }}" method="get"
        ...
        @foreach ($todayCasts as $todayCast)
            @if ($todayCast->reservation == '')
                <x-public.shops.schedule-card
                    ...
                    message="{{ $todayCast->appeal_point }}" variant="schedule" contentGradientStart="#9C0909"
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M15 0V6.76622L9.26748 12.5L15 18.2313V25H0V18.2313L5.73123 12.5L0 6.76622V0H15ZM7.5 14.2675L2.50002 19.2675V21.875L7.5 18.75L12.5 21.875V19.2675L7.5 14.2675ZM12.5 2.50002H2.50002V5.73123L4.27166 7.50333L10.7435 7.4881L12.5 5.73123V2.50002Z" fill="#F5F5F5"/>
                    ...
                    badgeBorderColor="#D90D32" badgeBgColor="#D90D32" badgeTextColor="#F2FF00" badgeTimeColor="#0F0002"
                    :messageGradient=false measurementsColor="#FEFEFE" nameColor="#FEFEFE" messageColor="#F2FF00" />
            @endif
        @endforeach
    </div>
