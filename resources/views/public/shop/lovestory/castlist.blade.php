<x-lovestory-page-layout page-title="CAST LIST" page-subtitle="キャスト一覧"
    breadcrumb="エッチな女の子育成ヘルス ラブストーリー ＞ トップページ ＞ キャスト一覧" :assets="['resources/scss/shops/lovestory/castlist.scss']" :banners="$banners">
    ...
    @endfor --}}
        ...
        @foreach ($castlist as $cast)
            <x-public.shops.schedule-card
                ...
                message="{{ $cast->appeal_point }}" variant="castlist"                                     contentGradientStart="#F2387C"
                ...
                nameColor="#1C2D48" messageColor="#1C2D48" />
        @endforeach
    </div>
