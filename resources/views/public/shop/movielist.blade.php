      ...
      <div class="movie-list content-wrapper-shop">
        @foreach ($movies as $movie)
          <div class="movie-list-item">
              <div class="movie-list-item-frame">
                <video class="movie-list-item-movie" controls preload="metadata" playsinline @if ($movie->thumb_url) poster="{{ asset('storage/' . $movie->thumb_url) }}" @endif>
