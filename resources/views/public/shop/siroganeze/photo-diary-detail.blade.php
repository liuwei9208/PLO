...
<x-siroganeze-page-layout page-title="PHOTO DIARY DETAIL" page-subtitle="{{ $diary->cast_name }}"
    breadcrumb="すすきの Premium Men’s Esthe シロガネーゼ ＞ トップページ ＞ 写メ日記 ＞ 写メ日記詳細" :assets="['resources/scss/shops/siroganeze/photo-diary-detail.scss']" :banners="$banners">
        ...
        <div class="photo-diary-details-section-content">
            ...
            <div class="photo-diary-details-section-content-right">
                ...
                <div class="blog-pagination">
                    @if ($prevDiary)
                        <a href="{{ route('public.shops.shop.photo-diary.detail', ['shop' => 'siroganeze', 'id' => $prevDiary->id]) }}"
                    ...
                    @endif
                    <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'siroganeze']) }}"
                        class="blog-pagination-btn blog-pagination-list">
                        <p>一覧へ</p>
                    </a>
                    @if ($nextDiary)
                        <a href="{{ route('public.shops.shop.photo-diary.detail', ['shop' => 'siroganeze', 'id' => $nextDiary->id]) }}"
...
@once
    @vite(['resources/scss/shops/siroganeze/photo-diary-detail.scss', 'resources/js/shops/siroganeze/photo-diary-detail.js'])
@endonce
