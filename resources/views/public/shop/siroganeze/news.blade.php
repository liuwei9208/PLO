<x-siroganeze-page-layout page-title="NEWS" page-subtitle="新着情報"
    breadcrumb="すすきの Premium Men’s Esthe シロガネーゼ ＞ トップページ ＞ 新着情報" :assets="['resources/scss/shops/siroganeze/news.scss']" :banners="$banners">
    <section class="news-section">
        @foreach ($news as $new)
            <x-public.shops.news-card image="{{ asset('storage/' . $new->thumbnail) }}" image-alt="news-image"
                ...
                :url="route('public.shops.shop.news.detail', ['shop' => 'siroganeze', 'id' => $new->id])" scss="resources/scss/shops/siroganeze/component/news-card.scss">
                {!! nl2br($new->contents) !!}
