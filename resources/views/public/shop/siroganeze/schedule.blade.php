<x-siroganeze-page-layout page-title="SCHEDULE" page-subtitle="出勤情報"
    breadcrumb="すすきの Premium Men’s Esthe シロガネーゼ ＞ トップページ ＞ 出勤情報" :assets="['resources/scss/shops/siroganeze/schedule.scss']" :banners="$banners">
    ...
    <div class="schedule-menu">
        <div class="search-list">
            ...
            <img src="{{ asset('assets/img/shops/siroganeze/schedule-icon.png') }}" alt="出勤日で検索" class="schedule-icon">
            <p>出勤日で検索</p>
        </div>
        <form action="{{ route('public.shops.shop.schedule', ['shop' => 'siroganeze']) }}" method="get"
