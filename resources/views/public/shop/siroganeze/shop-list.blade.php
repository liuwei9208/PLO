<x-siroganeze-page-layout -page-layout page-title="SHOP LIST" page-subtitle="店舗一覧"
    breadcrumb="すすきの Premium Men’s Esthe シロガネーゼ ＞ トップページ ＞ 店舗一覧" :assets="['resources/scss/shops/siroganeze/shop-list.scss']" :banners="$banners">
