<x-siroganeze-page-layout -page-layout page-title="EVENT" page-subtitle="イベント情報"
    breadcrumb="すすきの Premium Men’s Esthe シロガネーゼ ＞ トップページ ＞ イベント情報 ＞ {{ $event->title }}" :assets="['resources/scss/shops/siroganeze/event-detail.scss']"
    :banners="$banners">
