    ...
    <section class="newcast-section">
        ...
        @foreach ($new_girls as $new_girl)
            <x-public.shops.new-girl-card
                ...
                :gradient=false datetextColor="#48593F" newGirlCardBgLeftColor="rgba(255,255,255,0.7)"
                name-color="#132126" measurements-color="#132126" :cardGradient=false carddividerColor="#48593F"
                :carddividerverticalGradient=false carddividerverticalColor="#48593F"
