...
<x-public-groups-sub-page-layout>
  ...
  <div class="photodiary">
   <section>
    <div class="all-shops-buttons">
      <button class="all-shops-button all-shops-button--main">
        全店舗
      </button>
      <div class="all-shops-grid">
        <div class="all-shops-grid-row">
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'shizuku']) }}" class="all-shops-button all-shops-button--shop all-shops-button--shizuku">
            <img src="{{ asset('assets/img/groups/photo-diary-button1.png') }}" alt="Shizuku">
          </a>
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'shiroganeze']) }}" class="all-shops-button all-shops-button--shop">
            <img src="{{ asset('assets/img/groups/photo-diary-button2.png') }}" alt="Siroganeze">
          </a>
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'lovestory']) }}" class="all-shops-button all-shops-button--shop">
            <img src="{{ asset('assets/img/groups/photo-diary-button3.png') }}" alt="Love Story">
          </a>
        </div>
        <div class="all-shops-grid-row">
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'pussycat']) }}" class="all-shops-button all-shops-button--shop all-shops-button--pussycat">
            <img src="{{ asset('assets/img/groups/photo-diary-button4.png') }}" alt="Pussycat">
          </a>
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'miyabi']) }}" class="all-shops-button all-shops-button--shop all-shops-button--miyabi">
            <img src="{{ asset('assets/img/groups/photo-diary-button5.png') }}" alt="Miyabi">
          </a>
          <a href="{{ route('public.shops.shop.photo-diary', ['shop' => 'en']) }}" class="all-shops-button all-shops-button--shop">
