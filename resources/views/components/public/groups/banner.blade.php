...
@if(!request()->routeIs('public.recruit.*'))
<a href="{{ route('public.groups.girl-search') }}"
  class="banner-girl-search-btn {{ request()->routeIs('public.groups.newface') ? 'banner-girl-search-btn--newface' : '' }}">
