        ...
        @if ($messageGradient)
          <div class="schedule-card-message-container">
            <div class="schedule-card-message-content">
              <p class="schedule-card-message-text @if ($variant === 'castlist' || $variant === 'castlist_top') castlist-card-message @endif" style="background: linear-gradient(180deg, {{ $messageGradientStart }} 20.67%, {{ $messageGradientEnd }} 100%); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">{!! $message !!}</p>
            </div>
          </div>
        @else
        <div class="schedule-card-message-container">
            <div class="schedule-card-message-content">
              <p class="schedule-card-message-text @if ($variant === 'castlist' || $variant === 'castlist_top') castlist-card-message @endif" style="color: {{ $messageColor }}; -webkit-text-fill-color: {{ $messageColor }};">{!! $message !!}</p>
            </div>
        </div>
        @endif
    </div>
