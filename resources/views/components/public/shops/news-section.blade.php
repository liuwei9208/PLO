...
@php
    $wrapperClass = $variant === 'diary' ? 'diary-slider-wrapper' : 'news-slider-wrapper';
    $prevClass = $variant === 'diary' ? 'diary-slider-prev' : 'news-slider-prev';
    $nextClass = $variant === 'diary' ? 'diary-slider-next' : 'news-slider-next';
    $contentClass = $variant === 'diary' ? 'diary-content' : 'news-content';
    $cardClass = $variant === 'diary' ? 'diary-content-card' : 'news-content-card';
    $imageClass = $variant === 'diary' ? 'diary-content-card-image' : 'news-content-card-image';
    $dateClass = $variant === 'diary' ? 'diary-content-card-date' : 'news-content-card-date';
    $contentTextClass = $variant === 'diary' ? 'diary-content-card-content' : 'news-content-card-content';
@endphp
