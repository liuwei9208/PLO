<nav class="bottom-nav">
    ...
    <div class="tel-link-container">
      <a href="tel:{{ $shop->tel }}" class="tel-link --{{ $shop->slug }}">
        <svg height="800" width="800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 473.806 473.806" xml:space="preserve">
            <g>
                <g>
        ...
        <!-- <img src="{{ asset('assets/img/shop/phone-icon.svg') }}" alt="電話" class="tel-icon"> -->
      </a>
    </div>
</nav>
