        ...
        <ul class="flex flex-col gap-4 mb-6">
         ...
         <li>
          <a
            ...
            @click="selected = (selected === 'Video' ? '':'Video')"
            class="menu-item group"
            :class=" (selected === 'Video') ? 'menu-item-active' : 'menu-item-inactive'"
          >
            <svg
              :class="(selected === 'Video') && (page === 'video') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <li>
            <a
              href="#"
              @click.prevent="selected = (selected === 'Schedule' ? '':'Schedule')"
              class="menu-item group"
              :class=" (selected === 'Schedule') || (page === 'schedule') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
              ...
              <svg class="menu-item-arrow" :class="[(selected === 'Schedule') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>

            <!-- Dropdown Menu Start -->
            <div class="overflow-hidden transform translate block" :class="(selected === 'Schedule') ? 'block' :'hidden'">
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                <li>
                  <a
                    href="{{ url('/admin/work') }}"
          ...
          <li>
            <a
              href="#"
              @click.prevent="selected = (selected === 'Members' ? '':'Members')"
              class="menu-item group"
              :class=" (selected === 'Members') || (page === 'member') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'Members') || (page === 'member') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <svg class="menu-item-arrow" :class="[(selected === 'Members') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>

            <!-- Dropdown Menu Start -->
            <div class="overflow-hidden transform translate block" :class="(selected === 'Members') ? 'block' :'hidden'">
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                <li>
                  <a
                    href="{{ url('/admin/member') }}"
          ...
          <li>
            ...
            >
              <svg
                :class="(selected === 'Fee') && (page === 'fee') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
